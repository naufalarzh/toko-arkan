...
const CartItem = ({ item, kurangKuantitas, tambahKuantitas }) => {
  return (
    <div className="flex justify-between items-center text-xs bg-[#0F0A1A] p-2 rounded-xl shadow-sm">
      ...
      <div className="flex items-center space-x-2.5">
        ...
        <div className="flex items-center space-x-1.5 bg-[#0F0A1A] px-2 py-1 rounded-lg">
          <button
