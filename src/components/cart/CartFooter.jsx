  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#1C2541]/95 border-t border-slate-800 shadow-2xl z-40 p-4 max-w-4xl mx-auto rounded-t-3xl backdrop-blur-md">
      ...
      <div className="flex items-center justify-between px-1">
        ...
        <button onClick={onCheckout} className="bg-emerald-500 text-[#0B1329] px-4 py-2 sm:px-6 sm:py-2.5 rounded-xl font-bold text-xs shadow-lg transition hover:bg-emerald-400">
          Selesai
        </button>
      </div>
    </div>
